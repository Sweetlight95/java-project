...
public class StreamOfLines {
    public static void main(String[] args) throws IOException {
        ...
        Map<String, Long> wordCounts = Files.lines(Paths.get("Chapter2Paragraph.txt"))
                ...
                .flatMap(line -> pattern.splitAsStream(line)).collect(Collectors.groupingBy
                        (String::toLowerCase, TreeMap::new, Collectors.counting()));

        wordCounts.entrySet().stream().collect(Collectors.groupingBy(entry -> entry.getKey().charAt(0),TreeMap::new,
